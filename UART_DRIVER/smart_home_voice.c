...
/*void main()
 {
	...
	DIO_SetPinDirection(DDRD , PIN4 , OUTPUT);
	DIO_SetPinDirection(DDRD , PIN3 , OUTPUT);
	DIO_SetPinDirection(DDRD , PIN2 , OUTPUT);
		...
		else if(state == 2)
		{
			 ...
			 if(R_num != no_data && (R_num == '0' ||R_num == '1' || R_num == '2' || R_num == '3' || R_num == '4' || R_num == '5'))
			 {
				 ...
				 if(R_num == '1')
				 {
					 ...
					 LCD_voidGoToXY(0, 1) ;
					 LCD_Display("LED_ON") ;
					 USART_voidSendString("the light is On\r");
				 ...
				 else if(R_num == '2')
				 {
						 ...
						 LCD_voidGoToXY(0, 1) ;
						 LCD_Display("LED_OFF") ;
						 USART_voidSendString("light is off now \r");
				...
				else if (R_num == '3')
				{
					Timer1_voidInit();
					 ...
					 USART_voidSendString("nice ,enjoy the Music\r");
				...
				else if(R_num == '4')
				{
					DIO_SetPinValue(PORTD , PIN6, HIGH);
					 ...
					 USART_voidSendString("ok ,Motor is working right now \r");
					// _delay_ms(10000);
				}
				else if(R_num == '5')
				{
					DIO_SetPinValue(PORTD , PIN6, LOW);
					 ...
					 USART_voidSendString("ok ,I have stop the Motor some thing else\r");
					_delay_ms(10000);
				}//

				else if(R_num == '0')
				{
					 USART_voidSendString("I'm gonna close the system good bye, walaa");
					 _delay_ms(3000);
					 LCD_voidSendCommand(0x01);
					 break ;
				}
